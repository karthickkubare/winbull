...
//				String B_sym = row.getCell(4).getStringCellValue();
				...
				Bfun.setRadioButton(driver, By.xpath("//*[@id=\"RpanelCommodityEntryForm\"]/div[1]/div[2]/div/div/div/label[1]"));
				}
				else if (c_type.equalsIgnoreCase("silver"))
				{
				Bfun.setRadioButton(driver, By.xpath("//*[@id=\"RpanelCommodityEntryForm\"]/div[1]/div[2]/div/div/div/label[2]"));	
				}
				Bfun.type(driver, By.name("fv[rcom_sell_tax]"), stax);
				Bfun.type(driver, By.name("fv[rcom_buy_tax]"), btax);
				Bfun.type(driver, By.name("fv[rcom_sell_tcs]"), Stcs);
				Bfun.type(driver, By.name("fv[rcom_buy_tcs]"), btcs);
				...
				Bfun.setRadioButton(driver, By.xpath("//*[@id=\"RpanelCommodityEntryForm\"]/div[5]/div[2]/div/div/div/label[1]"));
				}
				else if (active.equalsIgnoreCase("No"))
				{
				Bfun.setRadioButton(driver, By.xpath("//*[@id=\"RpanelCommodityEntryForm\"]/div[5]/div[2]/div/div/div/label[2]"));	
				}
